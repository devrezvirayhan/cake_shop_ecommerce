                    ...
                    <div className="col-lg-7 col-md-6 col-sm-12">
                        ...
                        <form onSubmit={handleRegister}>
                            ...
                            <TextField
                                ...
                                label="Your Password"
                                variant="standard" />
                            <Button type="submit" className="mt-3" style={{ width: '75%' }} variant="contained" color="success"> Sign-Up </Button>
                            <NavLink className="mt-3" style={{ textDecoration: 'none' }} to="/login">
